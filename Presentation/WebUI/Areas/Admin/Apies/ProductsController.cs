...
namespace WebUI.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        private void PopulateModel(Product model, IDictionary values) {
            ...
            string SEO_URL = nameof(Product.SeoUrl);
            ...
            string TAG = nameof(Product.Tag);
            string META_TITLE = nameof(Product.MetaTitle);
            string META_DESCRIPTION = nameof(Product.MetaDescription);
            string META_KEYWORD = nameof(Product.MetaKeyword);
            ...
            if(values.Contains(SEO_URL)) {
                model.SeoUrl = Convert.ToString(values[SEO_URL]);
            }
            ...
            if(values.Contains(TAG)) {
                model.Tag = Convert.ToString(values[TAG]);
            }

            if(values.Contains(META_TITLE)) {
                model.MetaTitle = Convert.ToString(values[META_TITLE]);
            }

            if(values.Contains(META_DESCRIPTION)) {
                model.MetaDescription = Convert.ToString(values[META_DESCRIPTION]);
            }

            if(values.Contains(META_KEYWORD)) {
                model.MetaKeyword = Convert.ToString(values[META_KEYWORD]);
            }
